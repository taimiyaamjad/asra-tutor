...
CRITICAL: Every single question object MUST have an 'answer' field and an 'options' field (which can be an empty array for numerical questions). Do not forget to include these fields for every question.
