...
export default function QuestionRealmPage() {
    ...
    <div className="space-y-8">
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            <CardTitle className="flex items-center gap-2"><Lightbulb /> Question Realm</CardTitle>
            <CardDescription>
              ...
              <Card key={post.id} className="hover:bg-muted/50 transition-colors">
                  <div className="flex items-center gap-2 p-2">
                      ...
                      <div className="flex-1 min-w-0">
                        <Link href={`/question-realm/${post.id}`} className="block group">
